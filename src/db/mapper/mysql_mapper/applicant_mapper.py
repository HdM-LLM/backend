...
class ApplicantMapper(MySQLMapper):
    ...
    def get_all(self):
        ...
        for tuple_data in tuples:
            (id, first_name, last_name, date_of_birth, street, postal_code, city, email, phone_number, face_image) = tuple_data
            applicant = Applicant(first_name, last_name, date_of_birth, street, postal_code, city, email, phone_number, face_image)
